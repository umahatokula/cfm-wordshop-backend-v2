                        ...
                        <div class="row mbn-20">
                            ...
                            <div class="col-12 mb-20">
                                <div class="row mbn-10">
                                    ...
                                    <div class="col-sm-9 col-12 mb-10">
                                        {!! Form::checkbox('is_active', 1, ['class' => 'custom-control-input', 'id' => 'is_active']) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-20 download_linkDiv">
                                <div class="row mbn-10">
                                    ...
                                    <div class="col-sm-9 col-12 mb-10">
                                        {!! Form::text('download_link', '', ['class' => 'form-control', 'id' =>
                            ...
                            <div class="col-12 mb-20 download_linkDiv">
                                <div class="row mbn-10">
                                    ...
                                    <div class="col-sm-9 col-12 mb-10">
                                        {!! Form::text('s3_key', '', ['class' => 'form-control', 'id' =>
                            ...
                            <div class="col-12 mb-20">
                                <div class="row mbn-10">
                                    ...
                                    <div class="col-sm-9 col-12 mb-10">
                                        <div class="adomx-checkbox-radio-group">
                                            <label class="adomx-checkbox-2">
                                                <input name="is_audio" id="is_audio" type="checkbox"> <i class="icon"></i> Audio?</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
