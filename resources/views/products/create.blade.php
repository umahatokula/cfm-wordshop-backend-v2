...
<div class="row">
            ...
            <div class="col-sm-9 col-12 mb-10">
                <div class="adomx-checkbox-radio-group">
                    <label class="adomx-checkbox-2">
                        {!! Form::checkbox('is_active') !!} <i class="icon"></i> Active/Inactive</label>
    ...
    <div class="col-12 mb-20">
        <div class="row mbn-10">
            ...
            <div class="col-sm-9 col-12 mb-10">
                {!! Form::number('unit_price', null,  ['class' => 'form-control', 'id' => 'unit_price']) !!}
            </div>
        </div>
    </div>
    <div class="col-12 mb-20 download_linkDiv">
        <div class="row mbn-10">
            ...
            <div class="col-sm-9 col-12 mb-10">
                {!! Form::text('download_link', null,  ['class' => 'form-control', 'id' => 'download_link']) !!}
            </div>
        </div>
    </div>
    <div class="col-12 mb-20 download_linkDiv">
        <div class="row mbn-10">
            ...
            <div class="col-sm-9 col-12 mb-10">
                {!! Form::text('s3_key', null, ['class' => 'form-control', 'id' => 's3_key']) !!}
            </div>
        </div>
    </div>
    <div class="col-12 mb-20" id="preacher_idDiv">
        <div class="row mbn-10">
            ...
            <div class="col-sm-9 col-12 mb-10">
                {!! Form::select('preacher_id', $preachers->pluck('name', 'id'), null, ['class' => 'form-control', 'id' => 'preacher_id']) !!}
            </div>
        </div>
    </div>
    <div class="col-12 mb-20" id="date_preachedDiv">
        <div class="row mbn-10">
            ...
            <div class="col-sm-9 col-12 mb-10">
                {!! Form::date('date_preached', null, ['class' => 'form-control', 'id' => 'date_preached']) !!}
            </div>
        </div>
    </div>
    <div class="col-12 mb-20">
        <div class="row mbn-10">
            ...
            <div class="col-sm-9 col-12 mb-10">
                {!! Form::select('categories[]', $categories->pluck('name', 'id'), null, ['class' => 'form-control', 'id' => 'categories', 'multiple']) !!}
            </div>
        </div>
    </div>
    <div class="col-12 mb-20">
        <div class="row mbn-10">
            ...
            <div class="col-sm-9 col-12 mb-10">
                <!-- File Input -->
                {!! Form::file('product_file', null, ['class' => 'form-control', 'id' => 'product_file']) !!}
            </div>
        </div>
    </div>
    <div class="col-12 mb-20">
